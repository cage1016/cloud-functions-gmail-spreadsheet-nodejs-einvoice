...
const GCF_DRIVE_FOLDER = nconf.get('GCF_DRIVE_FOLDER');
...
exports.GCF_DRIVE_FOLDER = GCF_DRIVE_FOLDER;

// Constants
exports.NO_LABEL_MATCH = `Message doesn't match label`;
exports.UNKNOWN_USER_MESSAGE = 'Uninitialized email address';
exports.UNKNOWN_USER_EINVOICE_FOLDER = 'Uninitialized email address einvoice folder';
